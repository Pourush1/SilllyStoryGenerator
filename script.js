...
var storyContent =
  "It was 94 fahrenheit outside, so :insertx: went for a walk. When they got to :inserty:, they stared in horror \
...
function generateStory() {
  ...
  newStoryContent = storyContent.replace(/insertx|inserty|insertz/gi, function(
    matched
  ) {
  ...
  if (document.getElementById("uk").checked) {
    ...
    story.textContent = newStoryContent.replace(
      "94 fahrenheit",
